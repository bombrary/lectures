...
declare type Events<T> = Extract<keyof T, string | symbol>;
export default class TypedEventEmitter<T extends {
    [event in Events<T>]: (...args: any[]) => void;
    ...
    emit: <E extends Events<T>, F extends T[E]>(event: E, ...args: F extends (...args: infer R) => any ? R : never) => boolean;
    eventNames: () => Events<T>[];
