...
export declare const mimeTypes: {
    [ConvertType.html]: string;
    [ConvertType.pdf]: string;
    [ConvertType.png]: string;
    [ConvertType.pptx]: string;
    [ConvertType.jpeg]: string;
};
...
export declare type ConvertedCallback = (result: ConvertResult) => void;
export declare class Converter {
    readonly options: ConverterOption;
    constructor(opts: ConverterOption);
    readonly template: Template;
    convert(markdown: string, file?: File): Promise<TemplateResult>;
